...
* Infantry Weapons' **Kick** has been changed to **push the player's view up** instead of to the top right.[/list]
...
* **Grenade Launchers** now have their own **Damage Type** and have had their damage against **Buildings** increased.[/list]
### Vehicle Chassis 
